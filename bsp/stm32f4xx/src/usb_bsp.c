...
__IO uint16_t RX_FIFO_FS_SIZE;
__IO uint16_t TX0_FIFO_FS_SIZE;
__IO uint16_t TX1_FIFO_FS_SIZE;
__IO uint16_t TX2_FIFO_FS_SIZE;
__IO uint16_t TX3_FIFO_FS_SIZE;
#endif
...
{
#ifdef USB_OTG_FS_CORE
  RX_FIFO_FS_SIZE = RX_FIFO_FS_SIZE_MSC;
  TX0_FIFO_FS_SIZE = TX0_FIFO_FS_SIZE_MSC;
  TX1_FIFO_FS_SIZE = TX1_FIFO_FS_SIZE_MSC;
  TX2_FIFO_FS_SIZE = TX2_FIFO_FS_SIZE_MSC;
  TX3_FIFO_FS_SIZE = TX3_FIFO_FS_SIZE_MSC;
#endif
  ...
  USBD_Init(&USB_OTG_Core,
          ...
          USB_OTG_FS_CORE_ID,
#endif
          &USR_MSC_desc, &USBD_MSC_cb, &USR_cb);

  //#ifdef USB_OTG_FS_CORE
  //  RX_FIFO_FS_SIZE = RX_FIFO_FS_SIZE_AUDIO;
  //  TX0_FIFO_FS_SIZE = TX0_FIFO_FS_SIZE_AUDIO;
  //  TX1_FIFO_FS_SIZE = TX1_FIFO_FS_SIZE_AUDIO;
  //  TX2_FIFO_FS_SIZE = TX2_FIFO_FS_SIZE_AUDIO;
  //  TX3_FIFO_FS_SIZE = TX3_FIFO_FS_SIZE_AUDIO;
  //#endif
  //
  //  USBD_Init(&USB_OTG_Core,
  //#ifdef USE_USB_OTG_HS
  ...
  //          USB_OTG_FS_CORE_ID,
  //#endif
  //          &USR_AUDIO_desc, &AUDIO_cb, &USR_cb);
}
...
void USB_Test(void)
{
  ...
  if (GPIO_ReadInputDataBit(GPIOA, GPIO_Pin_9) == Bit_RESET) //5 v
  {
    //Fail_Handler();
  }
...
//#ifdef USE_ULPI_PHY // ULPI
//  RCC_AHB1PeriphClockCmd( RCC_AHB1Periph_OTG_HS |
//          RCC_AHB1Periph_OTG_HS_ULPI, DISABLE);
//#else
