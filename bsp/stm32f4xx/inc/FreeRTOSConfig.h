...
#define configTIMER_TASK_PRIORITY			( tskIDLE_PRIORITY + configMAX_PRIORITIES - 1 )
#define configTIMER_QUEUE_LENGTH			( 10 ) /* XXX */
#define configTIMER_TASK_STACK_DEPTH			( 64 )
#define configTIMER_API_TIMEOUT_TICKS			( 100 )
